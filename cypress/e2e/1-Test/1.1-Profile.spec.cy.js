...
cy.wait(2000)
    ...
    //  cy.get('span.required').eq(0).should('have.css', 'background-color', 'rgb(255 0 0)')
    //  cy.get('.required').eq(1).should('background-color.red')
    // cy.get('.required').eq(2).should('background-color.red')
    // cy.get('.required').eq(3).should('background-color.red')
