context('Proactive messages', () => {
 ...
 cy.wait(2000)
  ...
  cy.contains('Management Version').click()
  ...
  cy.contains('Advanced settings').click({timeout:10000})
  cy.contains('Chatbot').click({timeout:5000})
...
//Duplicate
  ...
  cy.wait(2000)
	cy.get(':nth-child(1) > .p-dropdown-item',{timeout:8000}).click({ force: true })
	cy.wait(1000)
